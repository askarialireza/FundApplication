...
namespace Fund
{
    public partial class DatePickerPopup
    {
        ...
        {
            currentYear = FarsiLibrary.Utils.PersianDate.Now.Year;
            currentMonth = FarsiLibrary.Utils.PersianDate.Now.Month;
            currentDay = FarsiLibrary.Utils.PersianDate.Now.Day;
